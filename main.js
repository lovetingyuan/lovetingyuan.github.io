...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
        ...
        var $39f226 = exports.default || module.exports;
      
      if (typeof $39f226 === 'function') {
        $39f226 = $39f226.options;
      }
    
        /* template */
        Object.assign($39f226, (function () {
...
exports.default = _default;
        var $0b911d = exports.default || module.exports;
      
      if (typeof $0b911d === 'function') {
        $0b911d = $0b911d.options;
      }
    
        /* template */
        Object.assign($0b911d, (function () {
...
var staticRenderFns = []
          ...
          return {
            ...
            staticRenderFns: staticRenderFns,
            _compiled: true,
            _scopeId: "data-v-0b911d",
            functional: undefined
          };
        })());
      
},{"./components/Header.vue":"K/mD"}],"QPfz":[function(require,module,exports) {
...
var request = {
  get: function get(url) {
    var baseUrl = (typeof location === "undefined" ? "undefined" : _typeof(location)) === 'object' ? location.origin : this.origin;
...
exports.default = _default;
        var $d75820 = exports.default || module.exports;
      
      if (typeof $d75820 === 'function') {
        $d75820 = $d75820.options;
      }
    
        /* template */
        Object.assign($d75820, (function () {
  ...
  return new _vueRouter.default({
    ...
    routes: [{
      ...
      component: function component() {
        return require("_bundle_loader")(require.resolve('./views/About.vue'));
      }
    }]
  });
};
...
exports.default = _default;
},{"vue-router":"7ov2","vue":"QPfz","./views/Home.vue":"XQhA","_bundle_loader":"21/1","./views/About.vue":[["About.77d02d3d.js","15h9"],"15h9"]}],"iz0v":[function(require,module,exports) {
"use strict";
...
function createVueStore(modules, option) {
  ...
  var base = {
    addModule: function addModule(path, _module) {
    ...
    removeModule: function removeModule(path) {
      'use strict';
      ...
      try {
        ...
        throw new Error("Only dynamic module can be removed while ".concat(path, " is an initial module."));
      }
    },
    subscribe: function subscribe(listener) {
      ...
      var _listener = function _listener(data, state) {
        listener(data, state);
      };
    ...
    replaceState: function replaceState(state) {
      var _store = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : store;
      ...
      Object.keys(state).forEach(function (key) {
        if (/[A-Z]/.test(key[0])) {
          ...
          if (_store[key]) {
            ...
            throw new Error("Namespace sub module ".concat(key, " does not exist"));
          }
        } else {
    ...
    watch: function watch(fn, cb, option) {
    ...
    hotUpdate: function hotUpdate(path, _module) {
  ...
  function _createStore(Modules) {
    ...
    Object.keys(Modules).forEach(function (key) {
      if (/[A-Z]/.test(key[0])) {
        ...
        var _createStore2 = _createStore(Modules[key], routes.concat(key)),
            _createStore3 = _slicedToArray(_createStore2, 3),
            _Module = _createStore3[0],
            _state = _createStore3[1],
            _stateGetters = _createStore3[2];
        ...
        if (typeof getter === 'function') {
          ...
          if (key[0] === '$') {
            Module[key] = function (payload) {
              if (subscribeName) {
                eventBus.$emit(subscribeName, {
                  actionType: routesPath ? "".concat(routesPath, "/").concat(key) : key,
                  payload: payload
                }, state);
              }
            ...
            Module[key] = function (payload) {
              ...
              if (subscribeName) {
                eventBus.$emit(subscribeName, {
                  type: routesPath ? "".concat(routesPath, "/").concat(key) : key,
                  payload: payload
                }, state);
              }
          ...
          Object.defineProperty(state, key, _descriptor);
          Object.defineProperty(stateGetters, key, _descriptor);
          Object.defineProperty(Module, key, _descriptor);
        }
      }
    });
  ...
  var _createStore4 = _createStore(modules),
      _createStore5 = _slicedToArray(_createStore4, 3),
      _store = _createStore5[0],
      state = _createStore5[1],
      stateGetters = _createStore5[2];
...
function () {
  function VueStorePlugin() {
    _classCallCheck(this, VueStorePlugin);
  }

  _createClass(VueStorePlugin, null, [{
    key: "install",
...
function createStore() {
  var store = VueStorePlugin.createVueStore({
    links: init([]),
    setLinks: function setLinks(links) {
      this.links = links;
    },
    $fetchLinks: function () {
      var _$fetchLinks = _asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return _api.default.get('/data/home.json');
...
},{"vue":"QPfz","./api":"LVu9"}],"QVnC":[function(require,module,exports) {
var global = arguments[3];
/**
...
var _default = function _default(context) {
  ...
  app.$router.onReady(function () {
    ...
    Promise.all(matchedComponents.filter(function (v) {
      ...
      if ("production" === 'development') {
        console.log("fetching data for ".concat(Component.__file, " ..."));
      }
...
exports.default = _default;
},{"./App.vue":"Js2s","vue":"QPfz","./router":"hPM2","./store":"iz0v","regenerator-runtime/runtime":"QVnC"}],"Yi9z":[function(require,module,exports) {
