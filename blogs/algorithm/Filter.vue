<template>
  ...
  <div class="float-right mb-4 flex gap-6">
    <label>
      全部
  ...
  <div class="float-right mr-10 flex gap-5" style="margin-right: 60px">
    <label>
      全部
...
watchEffect(() => {
  ...
  nextTick().then(() => {
    solvedCount.value = document.querySelectorAll('[data-leetcode-problems-filter] + table [data-status="solved"]').length
  })
})
</script>
